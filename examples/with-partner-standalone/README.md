...
-   initialize `window.IDKit` with the IDKit Example `app_id` / `action`, `verification_level: "device"`, `partner: true`, `show_modal: true`, and `disable_default_modal_behavior: true`
